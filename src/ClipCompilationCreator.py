...
class ClipCompilationCreator:
    def __init__(self, game: str, asset_path: str, output_path: str):
        ...
        self.intro_vid = os.path.join(asset_path, "intro.mp4")
        self.outro_vid = os.path.join(asset_path, "outro.mp4")
    ...
    def create_compilation(self):
        ...
        intro_clip = VideoFileClip(self.intro_vid)
        composite_clips.insert(0, intro_clip)
        outro_clip = VideoFileClip(self.outro_vid)
        composite_clips.append(outro_clip)
        ...
        compilation.write_videofile(final_audio_path, threads=8, temp_audiofile=raw_audio_path, remove_temp=True)
    ...
    def write_clips(self):
        ...
        for idx, (clip_id, clip) in enumerate(composite_clips.items()):
            ...
            clip.write_videofile(final_audio_path, threads=8, temp_audiofile=raw_audio_path, remove_temp=True)
